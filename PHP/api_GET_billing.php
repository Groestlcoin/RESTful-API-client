<?php
/*
Retrieves account details of merchant AtomicPay account.
...
For detailed schema, parameters, code snippet and returned responses, read https://atomicpay.io/api/en#resource-Billing
*/

$curl = curl_init();

curl_setopt_array($curl, array(
  CURLOPT_URL => "https://merchant.atomicpay.io/api/v1/billing?status=REPLACE_WITH_VALUE&dateStart=REPLACE_WITH_VALUE&dateEnd=REPLACE_WITH_VALUE",
